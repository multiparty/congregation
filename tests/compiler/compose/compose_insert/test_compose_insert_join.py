...
@pytest.mark.parametrize("party_data, expected", [
    (
        ...
        {
            "node_order":
                [Create, Create, Divide, Close, Multiply, Close, Join, AggregateSum, Project, Open, Collect],
    ...
    (
        ...
        {
            "node_order": [Create, Create, Divide, Multiply, Join, AggregateSum, Project, Open, Collect],
...
def test_join_composite(party_data, expected):
    ...
    j = join(mult_one, div_two, "j", [party_data[0]["col_names"][0]], [party_data[1]["col_names"][0]])
    agg = aggregate(j, "agg", [party_data[0]["col_names"][0]], party_data[0]["col_names"][1], "sum")
