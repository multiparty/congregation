...
def test_multiply_not_reversible(party_data, expected):
    ...
    p = multiply(cc, "mult", party_data[0]["col_names"][0], [party_data[0]["col_names"][1], 0])
    collect(p, {1, 2})
...
def test_multiply_reversible(party_data, expected):
