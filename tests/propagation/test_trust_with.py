...
"""
Tests for propagation of column-level trust with 
...
def test_create(col_names, trust_with_sets, expected_sets):
...
def test_project_simple(col_names, trust_with_sets, expected_sets):
...
def test_limit_simple(col_names, trust_with_sets, expected_sets):
...
def test_distinct_simple(col_names, trust_with_sets, expected_sets):
...
def test_filter_by_col_simple(col_names, trust_with_sets, expected_sets):
...
def test_filter_by_scalar_simple(col_names, trust_with_sets, expected_sets):
...
def test_sort_by_simple(col_names, trust_with_sets, expected_sets):
...
def test_concat_project(col_names, trust_with_sets, expected_sets):
...
def test_concat_limit(col_names, trust_with_sets, expected_sets):
...
def test_concat_distinct(col_names, trust_with_sets, expected_sets):
...
def test_concat_filter_by(col_names, trust_with_sets, expected_sets):
...
def test_concat_sort_by(col_names, trust_with_sets, expected_sets):
...
def test_concat_join(col_names, trust_with_sets, expected_sets):
